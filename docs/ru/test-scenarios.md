...
16. [Регрессионные проверки Этапа 12](#16-регрессионные-проверки-этапа-12)
17. [Wavelet-операции](#17-wavelet-операции)
18. [Быстрый старт с образцовым деревом](#18-быстрый-старт-с-образцовым-деревом)
19. [Страница per-file метрик](#19-страница-per-file-метрик)
20. [CLIP-семантический поиск + bands](#20-clip-семантический-поиск--bands)
21. [Колонка robust-copy на `/similar`](#21-колонка-robust-copy-на-similar)
22. [Streaming-голограмма](#22-streaming-голограмма)
23. [Режимы holographic spotlight](#23-режимы-holographic-spotlight)
24. [Per-object versioning](#24-per-object-versioning)
25. [GC орфанных шардов + GC embedding-ов](#25-gc-орфанных-шардов--gc-embedding-ов)
26. [Сценарии надёжности](#26-сценарии-надёжности)
27. [Wrap-up](#wrap-up)
...
**Цель.** Пороговая RLNC-erasure-схема (НЕ Шамир — см. theory.md §8) —
разбить произвольный файл на N долей с порогом K, восстановить из
любых K. Только как availability-бэкап; K−1 долей утекают
≈(K−1)/K открытого текста, так что encrypt-then-share для настоящей
секретности.
...
## 16. Регрессионные проверки Этапа 12
